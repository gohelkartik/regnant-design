function init() {
    ...
    if (document.querySelector(".footer-bottom h1")) {
    ...
    if (document.querySelector("#page2>h1")) {
        var clutter = "";
    ...
    if (document.querySelector("#page6>h1")) {
        var clutter3 = "";
    ...
    if (document.querySelector(".info-left h1")) {
        gsap.from(".info-left h1", {
            scrollTrigger: {
                trigger: "#studio-info",
                scroller: "#main",
                start: "top 70%",
    ...
    if (document.querySelector(".image-reveal-wrapper img")) {
        gsap.to(".image-reveal-wrapper img", {
            scrollTrigger: {
                trigger: "#studio-visual",
                scroller: "#main",
                start: "top bottom",
                end: "bottom top",
                scrub: true
...
function canvas(){
    if (!document.querySelector("#page3>canvas")) return;
...
function canvas1(){
    if (!document.querySelector("#page5>canvas")) return;
...
function canvas2(){
    if (!document.querySelector("#page7>canvas")) return;
